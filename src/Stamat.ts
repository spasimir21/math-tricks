...
class Stamat {
  ...
  public evaluateState() {
    const [bestMove, bestEvaluation] = minimax(this.difficulty, true, this.simulation, evaluateState);
    const [worstMove, worstEvaluation] = minimax(this.difficulty, false, this.simulation, evaluateState);
